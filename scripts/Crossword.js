...
module.exports.Crossword = function Crossword(questions, additional){
  var GRID_ROWS = Math.floor(questions.length / 2) + additional;
  var GRID_COLS = 20;
      ...
      toHtml : function(grid, show_answers){
        ...
        for(var r = 0; r < grid.length; r++){
          ...
          for(var c = 0; c < grid[r].length; c++){
            ...
            if(cell == null){
              ...
              if(is_start_of_word) {
                ...
                if(cell["across"] && cell["across"].is_start_of_word) {
                  additional += "data-across=\"" + cell["across"].index + "\" ";
                }
                if(cell["down"] && cell["down"].is_start_of_word) {
                  additional += "data-down=\"" + cell["down"].index + "\"";
                }
              }
            }
            ...
            //     label++;
            //  } else {
            html.push("<td class='" + css_class + "' title='" + r + "," + c + "'" + additional + ">");
            // }
